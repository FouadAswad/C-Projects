...
void create_magic_square(int n, char magic[99][99]);
void print_magic_square(int n, char magic[99][99]);
bool isodd(int n);

int main(){
    int n; //Variable to later hold order of magic array
    char magic[99][99]= { 0 }; //Initializes all elements of magic to 0
...
void create_magic_square(int n,char magic[99][99]){//Function to initialize magic square correct numbers at correct positions
...
void print_magic_square(int n, char magic[99][99]){//Function to print the magic square created by previous function
